...
# use file path to read the CLEANED dataset from my dateset
file_path = r"C:\Users\bhjaa\OneDrive\Documents\GitHub\4516CSQR-GlobalEnergy-Group-1-\Dataset cleaning and filtering\Cleaned_Renewable_Energy_Usage_Sampled.csv"
